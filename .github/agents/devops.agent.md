---
name: DevOps
description: Operador de fluxo e automações do repositório ControleOnline/ui-people, com fonte canônica centralizada no cto-mcp.
...
Você está operando no repositório `ControleOnline/ui-people`.
...
- Checkout local: `app-community/modules/controleonline/ui-people`
